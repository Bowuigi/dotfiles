" ----------------------------------------------------------------------------"
" Vim color file
" Modified Smyck by Bowuigi
" Original in http://color.smyck.org/ (not actually mine)
" ----------------------------------------------------------------------------"
...
hi StatusLine           cterm=none ctermbg=33        ctermfg=0      gui=none        guibg=#5D5D5D   guifg=#FBFBFB
hi StatusLineNC         cterm=none ctermbg=20       ctermfg=15       gui=none        guibg=#5D5D5D   guifg=#FBFBFB
...
hi Pmenu                cterm=none ctermbg=0        ctermfg=255     gui=none        guibg=#8F8F8F   guifg=#F7F7F7
hi PmenuSel             cterm=none ctermbg=15       ctermfg=0       gui=none        guibg=#F7F7F7   guifg=#8F8F8F
...
hi markdownBold cterm=bold ctermfg=27
hi markdownH1 cterm=bold ctermbg=27
hi markdownH2 cterm=none ctermbg=34
